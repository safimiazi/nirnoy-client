              ...
              <div className="grid grid-cols-2 gap-4 p-2">
                {item.children.map((child, childIndex) => (
                  <li key={childIndex} className="group relative">
                    <Link
                      href={child.path}
                      className="flex items-center gap-3 px-3 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 rounded-md whitespace-nowrap"
                    >
